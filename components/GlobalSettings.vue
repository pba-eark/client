  ...
  <div>
    <form v-if="props.renderForm == 'riskProfile'">
      ...
      <input
        type="text"
        :disabled="disabled"
        v-model="props.data.profileName"
      />
      ...
      <div v-if="!disabled">
        <Button
          text="Save"
          @click="$emit('update', props.data, originalData), (disabled = true)"
        />
    ...
    <form v-if="props.renderForm == 'sheetStatus'">
      ...
      <input
        type="text"
        :disabled="disabled"
        v-model="props.data.sheetStatusName"
      />
      <Button v-if="disabled" text="Edit" @click="disabled = false" />
      <div v-if="!disabled">
        <Button
          text="Save"
          @click="$emit('update', props.data), (disabled = true)"
        />
        <Button text="Unsave" @click="disabled = true" />
        <Button text="Delete" @click="$emit('delete', props.data)" />
      </div>
    ...
    <form v-if="props.renderForm == 'epicStatus'">
      ...
      <input
        type="text"
        :disabled="disabled"
        v-model="props.data.epicStatusName"
      />
      <Button v-if="disabled" text="Edit" @click="disabled = false" />
      <div v-if="!disabled">
        <Button
